...
public class MarqueController implements Serializable {
    ...
    @EJB
    private sessions.MarqueFacade ejbFacade;
    ...
    public void create() {
        persist(PersistAction.CREATE, ResourceBundle.getBundle("/msg").getString("MarqueCreated"));
    ...
    public void update() {
        persist(PersistAction.UPDATE, ResourceBundle.getBundle("/msg").getString("MarqueUpdated"));
    }

    public void destroy() {
        persist(PersistAction.DELETE, ResourceBundle.getBundle("/msg").getString("MarqueDeleted"));
        if (!JsfUtil.isValidationFailed()) {
    ...
    public Marque getMarque(java.lang.Integer id) {
