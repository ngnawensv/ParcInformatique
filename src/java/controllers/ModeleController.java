...
public class ModeleController implements Serializable {
    ...
    @EJB
    private sessions.ModeleFacade ejbFacade;
    ...
    public void create() {
        persist(PersistAction.CREATE, ResourceBundle.getBundle("/msg").getString("ModeleCreated"));
    ...
    public void update() {
        persist(PersistAction.UPDATE, ResourceBundle.getBundle("/msg").getString("ModeleUpdated"));
    }

    public void destroy() {
        persist(PersistAction.DELETE, ResourceBundle.getBundle("/msg").getString("ModeleDeleted"));
        if (!JsfUtil.isValidationFailed()) {
    ...
    public Modele getModele(java.lang.Integer id) {
    ...
    public static class ModeleControllerConverter implements Converter {
        ...
        public String getAsString(FacesContext facesContext, UIComponent component, Object object) {
            ...
            if (object instanceof Modele) {
                ...
                return getStringKey(o.getIdModele());
            } else {
