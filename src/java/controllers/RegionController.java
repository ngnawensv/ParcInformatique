...
public class RegionController implements Serializable {
    ...
    @EJB
    private sessions.RegionFacade ejbFacade;
    ...
    public void create() {
        persist(PersistAction.CREATE, ResourceBundle.getBundle("/msg").getString("RegionCreated"));
    ...
    public void update() {
        persist(PersistAction.UPDATE, ResourceBundle.getBundle("/msg").getString("RegionUpdated"));
    }

    public void destroy() {
        persist(PersistAction.DELETE, ResourceBundle.getBundle("/msg").getString("RegionDeleted"));
        if (!JsfUtil.isValidationFailed()) {
