...
public class AdresseController implements Serializable {
    ...
    @EJB
    private sessions.AdresseFacade ejbFacade;
    ...
    public void create() {
        persist(PersistAction.CREATE, ResourceBundle.getBundle("/msg").getString("AdresseCreated"));
    ...
    public void update() {
        persist(PersistAction.UPDATE, ResourceBundle.getBundle("/msg").getString("AdresseUpdated"));
    }

    public void destroy() {
        persist(PersistAction.DELETE, ResourceBundle.getBundle("/msg").getString("AdresseDeleted"));
        if (!JsfUtil.isValidationFailed()) {
    ...
    public Adresse getAdresse(java.lang.Integer id) {
