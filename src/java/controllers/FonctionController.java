...
public class FonctionController implements Serializable {
    ...
    @EJB
    private sessions.FonctionFacade ejbFacade;
    ...
    public void create() {
        persist(PersistAction.CREATE, ResourceBundle.getBundle("/msg").getString("FonctionCreated"));
    ...
    public void update() {
        persist(PersistAction.UPDATE, ResourceBundle.getBundle("/msg").getString("FonctionUpdated"));
    }

    public void destroy() {
        persist(PersistAction.DELETE, ResourceBundle.getBundle("/msg").getString("FonctionDeleted"));
        if (!JsfUtil.isValidationFailed()) {
